...
public class JoinTxn implements Record {
  private String host;
  private int port;
  ...
  public int compareTo (Object peer_) throws ClassCastException {
    throw new UnsupportedOperationException("comparing JoinTxn is unimplemented");
  }
  public boolean equals(Object peer_) {
    if (!(peer_ instanceof JoinTxn)) {
      return false;
    }
    if (peer_ == this) {
      return true;
    }
    JoinTxn peer = (JoinTxn) peer_;
    boolean ret = false;
